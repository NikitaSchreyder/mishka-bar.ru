...
const AboutIndexPage: React.FC = () => {
    ...
    const description = 'Mishka bar - это всегда хорошее настроение и море позитива ежедневно. Mishka bar – ресторан идеально подойдет делового обеда, семейного ужина, так и для тёплой встречи с друзьями и подругами. Мы дарим гостям хорошее настроение, которое передаём через наши невероятно вкусные блюда и напитки, весёлое и дружелюбное обслуживание и демократичные цены. Именно поэтому в Mishka bar комфортно всем.'
