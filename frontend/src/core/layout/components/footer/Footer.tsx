...
<<<<<<< HEAD
          <p className='footer_developer-content'>
            <a href='mailto:nikitaschreyder@gmail.com' className='footer_developer-content--link'>Разработка сайта: nikitaschreyder@gmail.com</a>
          </p>
=======
